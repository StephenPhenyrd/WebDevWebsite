...
export async function POST(request) {
    try {
      ...
      const client = await clientPromise;
      console.log("MongoDB client connected:", client); // Debug log
  
      const db = client.db("Cluster0"); // Replace "Cluster0" with your database name
      console.log("Using database:", db.databaseName); // Debug log
  
      const newReview = { location, barRating, drinkChoice, drinkRating, review };
